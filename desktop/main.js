 ...
 *
 * Serves app/ on 127.0.0.1. VA2GKA Replay uses the public server; the Python
...
/** IQ WebSocket for VA2GKA Replay inside the desktop window. */
    ...
    if (process.env.DIDAH_SMOKE) {
        win.webContents.on('did-finish-load', () => {
            win.webContents.executeJavaScript(`({
                replayChecked: !!document.querySelector('input[name="iq-source"][value="va2gka"]')?.checked,
